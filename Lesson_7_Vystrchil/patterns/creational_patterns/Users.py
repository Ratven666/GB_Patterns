...
from ..architectural_patterns.DomainObject import DomainObject


class User(ABC, DomainObject):
    auto_id = 0
    ...
    def __init__(self, name):
        self.name = name
        self.id_ = self.auto_id

    def __str__(self):
        return f"{self.__class__.__name__}:[id={self.id_}, name={self.name}]"
...
class Teacher(User):
    ...
    def __str__(self):
        return f"{self.__class__.__name__}:[id={self.id_}, name={self.name}, groups={self.groups}]"
